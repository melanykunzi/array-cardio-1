...
'Bent, Silas', 'Bentsen, Lloyd', 'Berger, Ingmar', 'Berio, Luciano',
'Berle, Milton', 'Berlin, Irving', 'Berio, Eric', 'Bernhard, Sandra', 'Berra, Yogi',
'Berry, Halle', 'Berry Wendell', 'Bethea, Erin', 'Bevan, Aneurin', 'Bevel, Ken',
'Biden, Joseph', 'Bierce, Ambrose', 'Biko, Steve', 'Billings, Josh',
'Biondo, FRank', 'Birrell, Agustine', 'Black, Elk', 'Blair, Robert', 'Blair, Tony',
'Blake, William'];
...
const nomyape  = inventors.map(function(inventor) {
...
const oldestyoungest = inventors.sort(function compareNumbers(a, b) {
    if (a.year > b.year){
        return 1;
    } else {
        return -1;
...
const oldest = inventors.sort(function compareNumbers(a, b) {
